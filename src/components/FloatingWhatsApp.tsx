...
export default function FloatingWhatsApp() {
    ...
    return (
        <a
            ...
            className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-[#128C7E] hover:bg-[#0e7268] text-white rounded-full shadow-lg transition-colors duration-300 group"
